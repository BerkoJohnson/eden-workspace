...
export const CreateNewElection = createAction(
  '[Election] Create Election',
  props<{ election: IElection }>(),
);
export const CreateNewElectionSuccess = createAction(
  '[Election] Create Election Success',
  props<{ election: IElection }>(),
);
export const CreateNewElectionFailure = createAction(
  '[Election] Create Election Failure',
  props<{ error: any }>(),
);
...
export const getElection = createAction(
  '[Elections] Retrieve Election',
  props<{ electionId: string }>(),
);
export const getElectionSuccess = createAction(
  '[Elections] Retrieve Election Success',
  props<{ election: IElection }>(),
);
